...
<head>
    ...
    <title>Macbook & iMac - Apple Store</title>
...
<body>
    ...
    <main class="products-container">
        ...
        <div class="main-content">
            <div class="active-filters-container">
                ...
                <a href="macbook.php" class="clear-all-filters">Xóa tất cả bộ lọc</a>
            </div>
    ...
    <script>
            ...
            if (filters.length > 0) {
                ...
                activeFiltersContainer.querySelectorAll('.remove-filter').forEach(removeBtn => {
                    removeBtn.addEventListener('click', function () {
                        ...
                        window.location.href = 'macbook.php?' + currentParams.toString();
                    });
                });
        ...
        document.querySelectorAll('a').forEach(link => {
            if (link.href.includes('macbook.php')) {
